        ...
        <div className="internal-app">
            ...
            <aside className={`internal-sidebar ${sidebarAberta ? 'open' : ''}`}>
                ...
                <nav className="sidebar-nav">
                    ...
                    <div className="nav-section">
                        <span className="nav-section-title">Operações & Serviços</span>
                        <div className="nav-group-items">
                            <NavLink
                                to="/interno/servicos"
                                onClick={fecharSidebar}
                    ...
                    <div className="nav-section">
                        <span className="nav-section-title">Base de Conhecimento</span>
                        <div className="nav-group-items">
                            <NavLink
                                to="/interno/licoes"
                                onClick={fecharSidebar}
                ...
                <div className="sidebar-footer">
                    <NavLink
                        to="/interno/perfil"
                        onClick={fecharSidebar}
                        className={({isActive}) => `sidebar-user-footer ${isActive ? 'active' : ''}`}
                        title="Ver meu perfil e configurações de conta"
                    >
                        ...
                        <div className="user-details">
                            <div className="user-name-line">
                                ...
                                <span className={`role-pill ${getRoleClass(usuario?.tipo)}`}>
                                    {usuario?.tipo || 'CONSULTA'}
                                </span>
                            </div>
                            <span className="user-handle" title={`@${usuario?.username}`}>@{usuario?.username}</span>
                        </div>
                        <div className="user-settings-icon" title="Configurações do perfil">
                    ...
                    <div className="footer-actions-row">
                        <Link to="/home" className="footer-action-mini" title="Voltar ao portal institucional público">
                        ...
                        <button onClick={handleLogout} className="footer-action-mini logout" title="Encerrar sessão de acesso">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none"
                                 stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
